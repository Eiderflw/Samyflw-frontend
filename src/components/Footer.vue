		...
		<footer>
			<div class="footer">
				<div class="row">
					...
					<a href="https://www.instagram.com/samyflw1/">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink"
							version="1.1"
				...
				<div class="row">
					<p>Métodos de pago en Samyflw:</p>
					<div>
						<img src="../assets/img/binance.png" alt="" />
						<img src="../assets/img/openpay.png" alt="" />
					</div>
				</div>

				<div class="row">Samyflw Copyright © 2024 - All rights reserved</div>
			</div>
		</footer>
	</div>
</template>
